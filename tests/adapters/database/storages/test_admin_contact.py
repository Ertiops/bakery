...
async def test__create(
    admin_contact_storage: AdminContactStorage,
) -> None:
...
async def test__get_last(
    ...
    admin_contact = await admin_contact_storage.get_last()
    assert admin_contact == AdminContact(
...
async def test__get_last__none(
    ...
    assert await admin_contact_storage.get_last() is None
...
async def test__update_by_id__entity_not_found_exception(
    ...
    with pytest.raises(EntityNotFoundException):
        await admin_contact_storage.update_by_id(
