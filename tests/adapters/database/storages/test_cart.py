...
async def test__create_or_update_by_id__validate_create(
    ...
    cart = await cart_storage.create_or_update(input_dto=create_data)
    assert cart == Cart(
        user_id=db_user.id,
...
async def test__create_or_update_by_id__validate_update(
    ...
    await cart_storage.create_or_update(input_dto=create_data)
...
async def test__get_w_product_by_user_product_ids(
    ...
    db_cart: CartTable = await create_cart()
    cart = await cart_storage.get_w_product_by_user_product_ids(
...
async def test__get_list(
    ...
    carts = await cart_storage.get_list(
