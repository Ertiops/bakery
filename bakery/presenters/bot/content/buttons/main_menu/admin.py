...
ORDER_SCHEDULE: Final[str] = "🗓 Расписание доставки"
FEEDBACK_GROUP: Final[str] = "💬 Отзывы"
BLACKLIST: Final[str] = "⛔ Черный список"
FAKE_USERS: Final[str] = "👤 Пользователи без Telegram"
UNPAID_ORDERS: Final[str] = "💸 Неоплаченные заказы"
